...
class Scribe extends State {
   ...
   */
  trust (source) {
    this.warn('[SCRIBE]', 'trusting source:', source.constructor.name);
  ...
  async init () {
    console.warn('[SCRIBE]', '[DEPRECATED]', 'init', 'init is deprecated in favor of "commit" semantic.  See: https://dev.fabric.pub/docs#commit');
    return this;
  }
