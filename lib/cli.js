 ...
 */
export default class CLI extends Fabric {
  /**
   * Base class for a terminal-like interface to the Fabric network.
  ...
  constructor (config) {
    ...
    if (this.config.oracle) {
      ...
      this.oracle = new Fabric.Service();

      // bind our events
      this.oracle.once('done', this._finalize.bind(this));

     // compute local function
      return this.oracle.compute(input);
    }
...
CLI.prototype._requestLogin = function () {
  let self = this;
...
CLI.prototype._handleConnectionOpen = function (connection) {
  let self = this;
...
// TODO: move to Fabric#Chat
CLI.prototype._handleConnectionClose = function (connection) {
  let self = this;
 ...
 * @return {CLI}
 */
CLI.prototype._handleChanges = function (msg) {
  let self = this;
...
CLI.prototype._handleCollectionUpdate = function (change) {
  let self = this;
...
CLI.prototype._handleReady = function handlerReady (event) {
