...
describe('@fabric/core/services/lightning Bolt12Semantics bridge', function () {
  it('Lightning.Bolt12Semantics re-exports bolt12Semantics', function () {
    assert.strictEqual(Lightning.Bolt12Semantics, bs);
  });
});
