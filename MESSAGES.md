...
This catalog: **76** decode names, **76** unique opcodes, **15** with a registered field schema, **20** Lightning AMP rows. Regenerated by `npm run docs:message-types`. Do not hand-edit the table.
...
| `CONTRACT_PUBLISH` | 95 | `0x005f` | `P2P_CONTRACT_PUBLISH` | yes | contracts |
| `CONTRACT_MESSAGE` | 96 | `0x0060` | `P2P_CONTRACT_MESSAGE` | yes | contracts |
