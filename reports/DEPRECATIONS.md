...
_Generated: 2026-03-21T08:03:51.103Z_
...
| --- | --- | --- |
| `node_modules/@humanwhocodes/config-array` | 0.13.0 | Use @eslint/config-array instead |
| `node_modules/@humanwhocodes/object-schema` | 2.0.3 | Use @eslint/object-schema instead |
...
| `node_modules/honkit/node_modules/rimraf` | 2.6.3 | Rimraf versions prior to v4 are no longer supported |
...
| `node_modules/semistandard/node_modules/eslint` | 8.57.1 | This version is no longer supported. Please see https://eslint.org/version-support for other options. |
| `node_modules/semistandard/node_modules/rimraf` | 3.0.2 | Rimraf versions prior to v4 are no longer supported |
...
| `settings/deprecations.js` | 11 | * @deprecated |
| `settings/deprecations.js` | 17 | * @deprecated |
| `settings/deprecations.js` | 23 | * @deprecated |
| `settings/deprecations.js` | 29 | * @deprecated |
| `settings/deprecations.js` | 35 | * @deprecated |
| `types/collection.js` | 308 | * @deprecated |
| `types/peer.js` | 192 | * @deprecated |
