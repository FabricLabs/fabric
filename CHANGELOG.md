...
## 2026-08-16
- **PR #185 file-count fold:** opcode freeze lives in [`MESSAGES.md`](MESSAGES.md) (generated table). Small added tests merged into files already on the PR (`tests/fabric.message.js`, `tests/fabric.peer.js`, `tests/fabric.wallet.js`, `tests/fabric.machine.js`, `tests/fabric.service.js`, `tests/bitcoin/service.js`, and existing added suites). Mesh chat notes moved from `docs/MESH_CHAT.md` into `MESSAGES.md`.
