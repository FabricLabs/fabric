...
## 2026-08-16
- **PR #185 file-count fold:** opcode freeze lives in [`MESSAGES.md`](MESSAGES.md). Small added tests, docs (`ARC`, message collections, types/services map), BIP-327 vectors, and sidecar `.d.ts` files merged into paths already on the PR. Mesh chat notes live in `MESSAGES.md`. `npm run messages` runs `functions/fabricMessageCollection.js`.
