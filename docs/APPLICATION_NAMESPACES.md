...
Formal ARC genesis / tip / spend: [`CONTRACTS.md`](CONTRACTS.md#application-resource-contracts-arc).  
...
[`FabricMessageCollection`](../MESSAGES.md#fabric-message-collections)
