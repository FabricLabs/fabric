...
- Peeled `P2P_CHAT_MESSAGE` and `P2P_PEERING_OFFER` deliver/observe locally only (no mesh `relayFrom`, no chat/peering budget burn, no candidate enqueue under the TCP last hop).
